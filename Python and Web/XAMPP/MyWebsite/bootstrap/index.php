...
<html lang="en">
  ...
  <?php include("navbar.html");?>
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('img/worldspic2.jpg'); background-position: 50% 30%;">
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
			...
			<figure class="figure" style="">
				<img src="img/robotDevelopment.png" style="width: 200px;">			
					<figcaption class="figure-caption" style="color:white;">Robot Development.<br>RobotC,PROS,C/C++</figcaption>
			</figure>
