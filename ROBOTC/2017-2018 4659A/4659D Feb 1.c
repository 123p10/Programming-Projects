...
#pragma config(Motor,  port7,           driveRF,       tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           driveRM,       tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           driveRB,       tmotorVex393_MC29, openLoop)
