...
#pragma config(Motor,  port4,           DriveL3,       tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           DriveR3,       tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port8,           DriveR2,       tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           DriveR1,       tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port10,          MogoL,         tmotorVex393_HBridge, openLoop)
